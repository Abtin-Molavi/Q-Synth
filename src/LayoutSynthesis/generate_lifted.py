...
from src.LayoutSynthesis.circuit_utils import strict_dependencies, relaxed_dependencies, all_cx_gates, cancel_cnots, gate_get_qubit
...
class GenerateLifted:
  ...
  def generate_encoding_line(self,f):
    ...
    f.write(f"; Lifted {relaxed} encoding ({withanc} ancillaries, {initial} initial mapping) for {self.args.circuit_in}\n")
